...
* The original package name 'com.mguzewski.springboot-starter-microservice' is invalid and this project uses 'com.mguzewski.springboot_starter_microservice' instead.
